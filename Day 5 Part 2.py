...
for dir in dirs:
  ...
  from_is = range(top[stack_from][1] - num + 1, top[stack_from][1] + 1)
  to_is = range(top[stack_to][1] + 1, top[stack_to][1] + num + 1)
  #print(list(from_is), list(to_is))
  
  #changing the top crate of the from stack
  top[stack_from] = (initArr[from_is[0] - 1][stack_from], from_is[0] - 1)
  ...
  #updating the top crate of the to stack 
